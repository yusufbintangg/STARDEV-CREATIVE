...
const ServiceCard = memo(({ item, index }) => {
  return (
        ...
        <motion.div
          className="bg-white p-6 rounded-lg shadow-xl hover:shadow-2xl h-full flex flex-col justify-between hover:scale-105 transition duration-300 flex flex-col hover:scale-80"
            initial={{
              opacity: 0,
