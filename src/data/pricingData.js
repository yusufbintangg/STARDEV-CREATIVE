  ...
  "Portofolio & Peronal Brand": [
    {
      ...
      features: [
        ...
        "Formulir kontak dasar (email)", "Sangat cepat loading time-nya", 
    ...
    },
    {
      ...
      features: [
        ...
        "Galeri visual unlimited produk/proyek", 
    ...
    },
    {
      ...
      features: [
        ...
        "Galeri dengan fitur filter & search", 
  ...
  "Corporate/Business": [
    {
      ...
      features: [
        "Desain responsif (dari template)",
        "Hingga 5 halaman konten (Home, About, Contact)",
  ...
  "Tour & Travel Management System": [
    {
      ...
      features: [
        "Katalog paket wisata (maks 50 paket)",
        "Formulir booking & request quote",
        "Integrasi WhatsApp order",
        "Dashboard untuk tracking lead",
    ...
    },
    {
      ...
      features: [
        "Manajemen Inventaris (alokasi kursi/kamar)",
        "Sistem Booking dengan kuota real-time",
        "Manajemen data pelanggan (CRM dasar)",
        "Otomatisasi Invoice & Voucher",
        "Integrasi payment gateway (VA, Kartu)",
        "Dashboard Admin untuk booking & keuangan",
    ...
    },
    {
      ...
      features: [
        "Semua fitur Integrated Booking",
        "Integrasi Komisi Agen & markup",
        "Laporan keuangan & profitabilitas paket",
        "Modul Supplier Management",
        "Sistem Review & Testimoni",
        "Keamanan SSL & backup harian",
